  ...
  const sections = [
    {
      title: "DESCRIPTION",
      content:
        "Le Bowl Box 3000 est un bol connecté qui vous permet de manger en toute sécurité. Il est équipé de capteurs qui analysent votre nourriture et vous alertent en cas de danger.",
      key: "desc",
    },
    {
      title: "3D",
      content:
        "Voici une vue 3D du produit, vous pouvez le manipuler pour voir tous les détails.",
      key: "3d",
    },
    {
      title: "ÉLECTRONIQUE",
      content:
        "Voici le schéma électronique du produit, vous pouvez le télécharger pour le consulter.",
      key: "electro",
    },
    {
      title: "PLUS",
      content:
        "Voici le code source du produit, vous pouvez le télécharger pour le consulter.",
      key: "plus",
    },
  ];
  ...
  const products = [
    {
      ...
      price: 200,
      oldPrice: 1000,
      image: "https://via.placeholder.com/50x30/87CEFA/000000?text=+",
    },
    {
      id: 2,
      name: "La Bowl Rouge",
      ...
      price: 250,
      oldPrice: 1100,
      image: "https://via.placeholder.com/50x30/FF0000/000000?text=+",
    },
    {
      id: 3,
      name: "La Bowl Verte",
      ...
      price: 180,
      oldPrice: 900,
      image: "https://via.placeholder.com/50x30/00CC00/000000?text=+",
    },
    {
      id: 4,
      name: "La Bowl Orange",
      ...
      price: 230,
      oldPrice: 950,
      image: "https://via.placeholder.com/50x30/FFAA00/000000?text=+",
    },
  ];
    ...
    <div>
      ...
      <section id="documentation" style={styles.container}>
        <div style={styles.titleLine}>
          <h1 style={styles.h1Title}>Documentation</h1>
          <Button
      ...
      <section id="customisation" style={styles.container}>
        <div style={styles.titleLine}>
          <h1 style={styles.h1Title}>Customisation</h1>
        </div>
              ...
              <div
                ...
                style={{
                  ...
                  ...(selectedProduct.name === product.name
                    ? { boxShadow: `0 0 15px 5px ${product.color}` }
                    : {}),
                }}
        ...
        <div style={styles.detailsContainer}>
          <p>
            <strong>MODEL :</strong> {selectedProduct.name}
          </p>
      ...
      <section id="contact" style={styles.container}>
        <div style={styles.titleLine}>
          <h1 style={styles.h1Title}>Contact & SAV</h1>
          <Button
            className="panier-button"
            variant="contained"
            sx={styles.cartButton}
